  ...
  return (
    <div>
      {topics.map((topic) => (
        <div
          key={topic._id}
          className="p-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 my-3 flex justify-between gap-5 items-start text-gray-900 dark:text-gray-100"
        >
          <div>
